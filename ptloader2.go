...
func (l *loader2) readAt(offset int64, n int) ([]byte, error) {
	buf := make([]byte, n)
...
func (l *loader2) readSongName() error {
...
func (l *loader2) detectVariant() error {
...
func (l *loader2) readSongInfo() error {
...
func (l *loader2) readSamples() error {
...
func (l *loader2) patternBase() int64 {
...
func (l *loader2) readPatterns() error {
	base := l.patternBase()
...
func (l *loader2) readSampleData() error {
...
// LoadPTModule2 parses a ProTracker MOD file from any io.ReadSeeker.
// Supports both 31-sample (M.K., FLT4, etc.) and 15-sample ORIG variants.
func LoadPTModule2(r io.ReadSeeker) (*mod.PTModule, error) {
	if r == nil {
		return nil, fmt.Errorf("reader is nil")
	}
	ld := &loader2{r: r, module: &mod.PTModule{}}
